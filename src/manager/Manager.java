...
public class Manager {
    ...
    public void gettingTaskById(int numberId){
        if (task.containsKey(numberId)) {
            ...
            System.out.println(epicTask.get(numberId));
    ...
    public void addendumSubtask(int idS, Subtask subtask) {
        subtaskTask.put(idS, subtask);
    }

    public void addendumEpic(int idS, Epic epic) {
        epicTask.put(idS, epic);
    }

    public void addendumTask(int idS, Task tasks) {
        task.put(idS, tasks);
    }
